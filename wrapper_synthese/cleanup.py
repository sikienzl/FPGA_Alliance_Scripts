#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""This script cleanup the
    source folder after a 
    full synthese (vasy, 
    boom, boog, loon) run.
"""
...
def usage():
    ...
    print("-f, --force removes without asking all files with extensions " + VBE + ", " + VST + ", " + XSC + ".")
...
def main():
    ...
    for filename in os.listdir(path):
        if filename.endswith(VBE) or filename.endswith(VST) or filename.endswith(XSC):
